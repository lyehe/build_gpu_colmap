...
**Windows:**
- `pycolmap-4.0.2-cp312-cp312-win_amd64.whl`
  - Works on Windows 10/11 x64
  - Python 3.12 specific
  - ~50-100 MB with CUDA

**Linux:**
- `pycolmap-4.0.2-cp312-cp312-manylinux_2_31_x86_64.whl`
...
# Users install with:
pip install pycolmap-4.0.2-cp312-cp312-*.whl
```
